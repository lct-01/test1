...
public class TestRetrofitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUserInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getUserInfo("4663591d0a154a6bbbbd9a7179096414_3431fea068df4f6ea462e97cb07d323c_use");
        ...
        btnUpdateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                updateEmail("4663591d0a154a6bbbbd9a7179096414_3431fea068df4f6ea462e97cb07d323c_use",
                        "liuct@qq.com");
            }
        });
    ...
    private void register() {
        ...
        userBean.setUsername("liuct");
        userBean.setEmail("liuct@qq.com");
